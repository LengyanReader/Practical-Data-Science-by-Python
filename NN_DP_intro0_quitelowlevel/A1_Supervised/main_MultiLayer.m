...
% XTrain = XTrain;  %  only output bias

% The test data
XTest = [XTest ones(size(XTest,1),1)];
% XTest = XTest; % only output bias
...
if dataSetNr == 1
    ...
    learningRate  = 0.01; % Change this, your learning rate 0.001
    elseif dataSetNr == 2
    numHidden     = 6;     % Change this, number of hidden neurons                        
    numIterations = 10000;   % Change this, number of iterations (epochs) 
    learningRate  = 0.15; % Change this, your learning rate 0.001                           
    elseif dataSetNr == 3
    numHidden     = 6;     % Change this, number of hidden neurons                     
    numIterations = 50000;   % Change this, number of iterations (epochs)
    learningRate  = 0.03; % Change this, your learning rate 0.001                      
    elseif  dataSetNr == 4 
    numHidden     = 8;     % Change this, number of hidden neurons                         
    numIterations = 50000;   % Change this, number of iterations (epochs) 
    learningRate  = 0.001; % Change this, your learning rate 0.001                          

end
    W0 = rand(numHidden,size(XTrain,2))/128; % Initialize your weight matrix W
    V0 = rand(length(unique(LTrain)),numHidden+1)/128; % Initialize your weight matrix V   
% Run training loop
tic;
