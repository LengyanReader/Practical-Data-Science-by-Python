...
numIterations = 65000;  % Change this, number of iterations (epochs)
learningRate  = 0.003; % Change this, your learning rate
W0 = rand(size(XTrain,2),length(unique(LTrain))); % Change this, initialize your weight matrix W
