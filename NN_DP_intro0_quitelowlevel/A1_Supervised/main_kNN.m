...
% merging data for  cross validation
X_All = combineBins(XBins, 1:length(XBins(:)));
L_All = combineBins(LBins, 1:length(LBins(:)));
...
partitions=3;  % a limitation here, there should be some improving mothods for this,but for this task, it seems ok
k_max=32;
